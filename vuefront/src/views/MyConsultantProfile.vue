<template>
    <div class="container">
        <div class="Conpro-con-1">
            <blockquote class="blockquote-conpro"><b><p>나의 컨설턴트</p></b></blockquote>
        ...
        <div class="Conpro-procon1" v-if="Consultant">
            ...
            <div class="Conimg">
                <img :src="'img/ConsultantInfo_image/ct1.png'" :alt="'project ' + (index + 1)"/>
            </div>
            <div class="Con-profile-section">
                <div class="project-description">
                  ...
                  <div class="conpro-info">
                    ...
                    <div class="conpro-info-int"><span>Name : &nbsp;</span>{{Consultant.name}}</div>
                    <div class="conpro-info-int"><span>Email : &nbsp;</span>{{ Consultant.email }}</div>
                    <div class="conpro-info-int"><span>경력 : &nbsp;</span>{{ Consultant.cnscareer }}</div>
                    <div class="conpro-info-int"><span>컨설팅 횟수 : &nbsp;</span>{{ Consultant.cnsproject }}</div>
                    </div>
...
export default {
    ...
    methods:{
        ...
        findcon(){
            ...
            axios.post(`${process.env.VUE_APP_BACK_END_URL}/myconsult/mycon`,getmemno , { headers: {'Content-Type': 'application/json' } })
          .then((res) =>{
