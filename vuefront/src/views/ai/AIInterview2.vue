  ...
  <div id="content" class="AI-Setting">
    ...
    <div class="device-check">
      <h3 class="AI-interview-title">
        질문 2<br /><span v-show="interviewStarted">{{aiquestion2.totalq}}</span>
      </h3>
...
export default {
  data() {
    return {
      ...
      aiquestion2:JSON.parse(localStorage.getItem('questionlist'))[1],
      mediaRecorder: null,
      recordedChunks: [],
      videoStream: null,
      wehereinpage:true,
  ...
  methods: {
    ...
    uploadRecordedVideo() {
      if (this.recordedChunks.length > 0) {
        ...
        .then(response => {
          localStorage.setItem('q2detail', JSON.stringify(response.data));
        ...
        this.$router.push({ name: "AIInterview3" });
      }
    },
    stopCamera() {
      this.stopStreaming();
