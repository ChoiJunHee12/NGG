  ...
  <div id="content" class="AI-Setting">
    ...
    <div class="device-check">
      <h3 class="AI-interview-title">
        질문 4<br /><span v-show="interviewStarted">{{aiquestion4.totalq}}</span>
      </h3>
...
export default {
  data() {
    return {
      ...
      aiquestion4: JSON.parse(localStorage.getItem('questionlist'))[3],
      mediaRecorder: null,
      recordedChunks: [],
      videoStream: null,
      wehereinpage:true,
  ...
  methods: {
    ...
    uploadRecordedVideo() {
      if (this.recordedChunks.length > 0) {
        ...
        .then(response => {
          localStorage.setItem('q4detail', JSON.stringify(response.data));
