    ...
    if (selectedFile) {
      ...
      try {
        ...
        const uploadResponse = await fetch(
          `${process.env.REACT_APP_BACK_END_URL}/consultProfiles/uploadProfileImage`,
          {
            method: "POST",
            body: formData,
          }
        ...
        const updateResponse = await fetch(
          `${process.env.REACT_APP_BACK_END_URL}/consultProfiles/${cnsno}/updateProfileImage`,
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
