...
public interface FeedbackRepository extends JpaRepository<IntResVO, IntResVOId> {
        ...
        @Query("SELECT new kr.co.ict.yourdream.feedback.FeedbackDetail_IntDetailDTO(a.question, a.answer, a.vhertz, a.vamplit, a.vempty, a.aifeedbk, a.escore, a.pscore) FROM IntDetailVO a WHERE a.intno=:intno")
