...
<div class="modal-overlay" @click="$emit('close',false)">
    ...
    <div class="reshduty-btncon row">
        ...
        <div @click="pagechage(8)" class="col-1" :class="{'reshduty-rbutton':true, 'reshduty-active': activePage === 8}">종합 평가</div>
    </div>
    <div :style="displayPage(1)" class="reshduty-con row scrollable-div">
        ...
        <div class="reshduty-qcon2">
            <div class="reshduty-vdiv">
            <img class="reshduty-video" src="\img\InterviewRes_image\res_demovideo.png">
            </div>
            
            <div class="reshduty-dgraph">
                <div id="graph2"></div>
                <div class="reshduty-stress">스트레스 : 80(%)</div>
            </div>
   
        </div>
        <div class="reshduty-qcon3">
            
            <div class="reshduty-dcontent row">
                <div class="reshduty-vcon col-1">
                <img class="reshduty-voicew" src="\img\InterviewRes_image\res_demovoice.png">
                </div>
                <div class="reshduty-voice col-2">
                    <div class="reshduty-voice1">
                    음성 안정도 : 90점
                </div>
                <div class="reshduty-voice1">
                    공백 시간 : 12초
  ...
  <!--          종합 평가                       -->  
    <div :style="displayPage(8)" class="reshduty-con row scrollable-div">
        ...
        <div class="reshduty-subtitle3 col-1"><div class="resh-subtitlecon3">컨설턴트 피드백</div></div>
        <hr>
        ...
        <div class="reshduty-subtitle3 col-1"><div class="resh-subtitlecon3">담당 컨설턴트 평가하기</div></div>
        <hr>
        <div class="reshduty-qcon10">
            <div class="reshduty-totalcom">
                <div style="margin:auto; text-align:center;">
                    <div style="width:100%; margin:10px;">
                        <input type="radio" name="review">&nbsp 매우 만족 &nbsp
                        <input type="radio" name="review">&nbsp 만족 &nbsp
                        <input type="radio" name="review">&nbsp 보통 &nbsp
                        <input type="radio" name="review">&nbsp 불만족 &nbsp
                        <input type="radio" name="review">&nbsp 매우 불만족
                    </div>
                    <div style="height:50px; margin:auto;">
                        <button class="resh-homebtn col-1" style="height:40px; line-height: 30px; width:110px; margin:10px;">제출하기</button>
                    </div>
                </div>
            </div>
        </div>
