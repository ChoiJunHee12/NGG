...
<input type="file" id="input-file" style="display:none;" @change="uploadchange"/> 
        ...
        <table class="cvwrite-cv-table">
            <tr>
                ...
                <td class="cvwrite-cv-td2"><input class="cvwrite-cv-input" placeholder="이력서 제목을 입력하세요"></td>
            </tr>
        </table>
...
<table class="cvwrite-cv1-table">
    <tr class="cvwrite-cv1-tr">
        <td rowspan="4" class="cvwrite-cv1-td1">프로필 사진 넣어주세요.</td>
        <td class="cvwrite-cv1-td2">성명</td>
        <td><input type="text" class="cvwrite-cv1-input" placeholder="성명" ></td>
        <td class="cvwrite-cv1-td4">출생년도</td>
        <td><input type="text" class="cvwrite-cv1-input" placeholder="출생년도" ></td>
    </tr>
    <tr class="cvwrite-cv1-tr">

        <td class="cvwrite-cv1-td2">주소</td>
        <td colspan="3"><input type="text" class="cvwrite-cv1-input" placeholder="주소"></td>

    </tr>
    <tr class="cvwrite-cv1-tr">

        <td class="cvwrite-cv1-td2">일반 전화</td>
        <td><input type="text" class="cvwrite-cv1-input" placeholder="일반 전화"></td>
        <td class="cvwrite-cv1-td4">휴대 전화</td>
        <td><input type="text" class="cvwrite-cv1-input" placeholder="휴대 전화"></td>
    </tr>
    <tr>

        <td class="cvwrite-cv1-td2">이메일</td>
        <td colspan="3"><input type="text" class="cvwrite-cv1-input" placeholder="이메일"></td>
...
<table class="cvwrite-cv2-table">
    ...
    <tr v-for="(cv2, index) in cvlist2" :key="index"><!-- 여기서 데이터 받을시 for문 -->
        <td class="cvwrite-cv2-td1"><input type="text" class="cvwrite-cv-input" placeholder="재학기간" v-model="cv2.td1"></td>
        <td class="cvwrite-cv2-td2"><input type="text" class="cvwrite-cv-input" placeholder="학교명"></td>
        <td class="cvwrite-cv2-td3"><input type="text" class="cvwrite-cv-input" placeholder="전공"></td>
        <td class="cvwrite-cv2-td4"><input type="text" class="cvwrite-cv-input" placeholder="학력"></td>
        <td class="cvwrite-cv2-td5"><input type="text" class="cvwrite-cv-input" placeholder="학점"></td>
        <td class="cvwrite-cv2-td6"><button class="cvwrite-delbtn" @click="delcv2(index)">삭제</button></td>
    </tr>
...
<table class="cvwrite-cv3-table">
    ...
    <tr v-for="(cv3, index) in cvlist3" :key="index"><!-- 여기서 데이터 받을시 for문 -->
        <td class="cvwrite-cv3-td1"><input type="text" class="cvwrite-cv-input" placeholder="재직기간" v-model="cv3.td1"></td>
        <td class="cvwrite-cv3-td2"><input type="text" class="cvwrite-cv-input" placeholder="회사명"></td>
        <td class="cvwrite-cv3-td3"><input type="text" class="cvwrite-cv-input" placeholder="직종"></td>
        <td class="cvwrite-cv3-td4"><input type="text" class="cvwrite-cv-input" placeholder="주요 직무"></td>
        <td class="cvwrite-cv3-td5"><input type="text" class="cvwrite-cv-input" placeholder="직급/직책"></td>
        <td class="cvwrite-cv3-td6"><button class="cvwrite-delbtn" @click="delcv3(index)">삭제</button></td>
    </tr>
...
<table class="cvwrite-cv4-table">
    ...
    <tr><!-- 여기서 데이터 받을시 for문 -->
        ...
        <td class="cvwrite-cv4-td2"><textarea class="auto-resize" placeholder="750자 이내로 입력하세요"></textarea></td>
    </tr>
    <tr>
...
<div class="cvwrite-button-container">
        <router-link to="cvlist"><button class="cvwrite-remove">이전으로</button></router-link>
